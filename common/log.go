...
//
type jiaLogStruct struct {
}

var JiaLog *jiaLogStruct

var isDebugLevel bool = false

func (sLog *jiaLogStruct) InitLogger(logLevel string) {
...
//
func (sLog *jiaLogStruct) Error(err interface{}, headers ...string) (reErr error) {
...
//
func (sLog *jiaLogStruct) Fatal(fatal interface{}, headers ...string) (reErr error) {
	if fatal != nil {
		// 基本信息
		contents := headers
...
//
func (sLog *jiaLogStruct) Info(args ...string) (err error) {
...
//
func (sLog *jiaLogStruct) InfoF(format string, args ...interface{}) (err error) {

	validF(format, args...)

	msg := fmt.Sprintf(format, args...)

	return JiaLog.Info(msg)
}
...
//
func (sLog *jiaLogStruct) DebugF(format string, args ...interface{}) (err error) {

	validF(format, args...)

	msg := fmt.Sprintf(format, args...)

	return JiaLog.Debug(msg)
}

func (sLog *jiaLogStruct) Debug(args ...string) (err error) {
...
// 输出到控制台，但是不加任何的修饰
func (sLog *jiaLogStruct) Console(args ...interface{}) (err error) {
...
// 输出到控制台，在一行
func (sLog *jiaLogStruct) ConsoleInLine(args ...interface{}) (err error) {
...
func (sLog *jiaLogStruct) Importance(infos ...string) (err error) {
...
//
func (sLog *jiaLogStruct) Warning(warning ...string) (err error) {
...
//
func (sLog *jiaLogStruct) WarningF(format string, args ...interface{}) (err error) {

	validF(format, args...)

	msg := fmt.Sprintf(format, args...)
	return JiaLog.Warning(msg)
}
...
func initLogger() {
	...
	writeSyncer := getLogWriter() //文件写入配置
	encoder := getEncoder()
	core := zapcore.NewTee(
...
func getLogWriter() zapcore.WriteSyncer {
	...
	logFilePath := filepath.Join(dirname, "logs", logFileName) // current user dir + ...
